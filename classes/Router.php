...
//		echo $this->last_url;
		...
		$match = array();
		if (preg_match("'^/".self::DEFAULT_ADMIN_ROUTE ."'i", $this->request_uri, $match)) {
			$this->is_admin = true;
			$this->admin_prefix = self::DEFAULT_ADMIN_ROUTE . '_';
			$this->request_uri = preg_replace("'^/".self::DEFAULT_ADMIN_ROUTE ."'i", '', $this->request_uri);
		} 
